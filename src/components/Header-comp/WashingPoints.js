                ...
                <div className="WP">
                    <div className='WP-container' >
                        ...
                        <p>
                                ...
                                <NavLink className="wordsWP" to={'/Contact'}>Home </NavLink>/
                                <NavLink className="wordsWP" to={'/Contact'}> Location</NavLink>
                    ...
                    <div className="WP-form">
                        <div className="location-form">
                            ...
                            <form>
                                ...
                                <div style={{width:''}}>
                                    <button id="btn-WP" data-testid='btn-WP' type="submit">Send Request</button>
                                </div>
                            </form>
                        </div>
                    </div>
